...
class MobileYOLOv5(Model):
    def __init__(
        ...
        backbone = Model(
            ...
            outputs=[backbone.layers[-1].output, backbone.layers[72].output, backbone.layers[35].output],
            name='mobile_net'
        )
        ...
        x = DepthwiseConv2D(kernel_size=3, padding='same', dilation_rate=2, use_bias=False)(x_mid)
